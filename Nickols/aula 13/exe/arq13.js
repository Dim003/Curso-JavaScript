const nome = prompt("Digite seu nome: ");
        ...
        document.body.innerHTML += `Qual o primeiro índice da letra A no seu nome? <strong>${nome.indexOf('a')+1}</strong><br />`
        document.body.innerHTML += `Qual o ultimo índice da letra A no seu nome? <strong>${nome.lastIndexOf('a')+1}</strong><br />`
